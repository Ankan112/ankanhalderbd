      ...
      <div className="hero min-h-screen ah-bg-banner">
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="">
            ...
            <h1 className="mb-8 mt-8 text-5xl font-bold">
              Hello, I am <span className="ah-color-third">Ankan Halder</span>
            </h1>
            <p className="mb-8 text-xl ah-color-secondary md:w-3/4 mx-auto">
              I am a frontend web developer from Bangladesh. I can provide clean
              code and pixel perfect design. I always provide my best service to
              clients so that they can be happy.
            </p>
            <div className="flex justify-center">
              <div className="flex gap-5">
                <a
                  ...
                  target="_blank"
                >
                  <div className="h-10 w-10 ah-bg-secondary duration-500 cursor-pointer border-2 border-gray-700 ah-color-secondary hover:bg-[#72E2AE] hover:text-black flex justify-center items-center">
